...
macro(pickup_std_sources)  
  ...
  kf_source_group("Include\\io" GLOB "include/io/*.h*")
  ...
  FILE(GLOB_RECURSE sources include/${module_name}/*.h* include/io/*.h* src/*.cpp src/*.h* src/cuda/*.h* src/cuda/*.c*)
endmacro()
...
macro(add_module_library name)
  ...
  pickup_std_sources()
  include_directories(include src src/cuda include/io)  
